...
export default function AnalysisView({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: '0' }}>
      ...
      {/* Top Banner Context */}
      <div className="mobile-padding" style={{ padding: '24px 32px', background: '#fff', borderBottom: '1px solid var(--border-light)' }}>
         <div className="mobile-flex-col" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
            <div>
         ...
         <div style={{ marginTop: 12, padding: summaryCollapsed ? '10px 12px' : '14px 16px', border: '1px solid var(--border-light)', borderRadius: 10, background: '#fafafa' }}>
            <div className="mobile-flex-col" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
              <div>
